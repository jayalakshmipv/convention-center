...
<title>Convention Centre| Find The Best Convention Centre </title>
<!-- Bootstrap -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="section-title mb60 text-center">
          <h1 id="b">OUR VISION  </h1>
          <p id="a">Our site is  mainly focused on to provide all the essential  details of the convention centers in our God's own country.We guide you through to make your function a memorable one &nbsp<a href="#">readmore... </a></p>
        </div>
      </div>
    </div>
    <div class="row"><!-- feature center -->
      <div class="col-md-4">
        <div class="feature-block feature-center"><!-- feature block -->
          ...
          <p> Here are the list of convention centers in kerala <a href="#">click on</a> </p>
        </div>
      </div>
      <!-- /.feature block -->
      ...
      <div class="col-md-4">
        <div class="feature-block feature-center"><!-- feature block -->
          ...
          <p id="a">If you have any query plz free to &nbsp<a href="#">contact us</a></p>
        </div>
      </div>
      <!-- /.feature block -->
      <div class="col-md-4">
