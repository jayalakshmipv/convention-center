  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/wedding-hub-decorators1.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
             <h2><a href="{{url('details')}}"><font color="white">Happy Decorators</font></a></h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/wedding-hub-decorators2.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Royal Decorators</h2>
              <p> Royal Decorators,Nagaroor Attingal, Trivandrum.</p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/wedding-hub-decorators3.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Modern Wedding Decorators</h2>
