  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/wedding-hub-jewllery1.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
             <h2><a href="{{url('details')}}"><font color="white">Bhima Jewellers</font></a></h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/wedding-hub-jewllery2.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Kalyan Jewellers</h2>
              <p>Kalyan Jewellers ,Nagaroor Attingal, Trivandrum.</p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/wedding-hub-jewllery3.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Joy Allukas</h2>
