      ...
      <div class="col-md-offset-2 col-md-8">
        <div class="page-header text-center">
          <div class="icon-circle"> 
              <i class="fa icon1 fa-shopping-bag"></i>
          </div>
          <h1>Apparel</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/skill-1.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
             <h2><a href="{{url('details')}}"><font color="white">Jayalakshmi Silks</font></a></h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/skill-2.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Kalyan Silks</h2>
              <p>Kalyan Silks ,Nagaroor Attingal, Trivandrum.</p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/skill-3.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Luxury Silks</h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/skill-1.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Cresent Silks and Weavers</h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/skill-3.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Camelot Trends and Silks</h2>
