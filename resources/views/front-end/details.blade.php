      ...
      <div class="col-md-12"> 
        ...
        <div class="tab-content"><!-- tab content start-->
          ...
          <div role="tabpanel" class="tab-pane fade" id="onmap">
            <div id="googleMap" class="map"><div style="width: 100%"><iframe width="100%" height="500" src="http://www.mapsdirections.info/en/custom-google-maps/map.php?width=100%&height=600&hl=ru&q=NH%20%24%26%2Ckazhakootam%2Cthiruvananthapuram+(al%20saj)&ie=UTF8&t=&z=14&iwloc=A&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="http://www.mapsdirections.info/en/custom-google-maps/">Create a custom Google Map</a> 
