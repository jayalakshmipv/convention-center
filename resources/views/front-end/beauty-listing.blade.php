    ...
    <div class="row">
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active">Beauty & Grooming</li>
        </ol>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/beauty_&_grooming-1.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
             <h2><a href="{{url('details')}}"><font color="white">Red Roses</font></a></h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/beauty_&_grooming-2.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Diana Beauty Clinic</h2>
              <p> Diana Beauty Clinic,Nagaroor Attingal, Trivandrum.</p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/beauty_&_grooming-3.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Modern Beauty Clinic</h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/beauty_&_grooming-2.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>White Girl Spa & Beauty Saloon</h2>
