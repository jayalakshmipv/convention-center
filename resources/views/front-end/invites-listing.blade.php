      ...
      <div class="col-md-offset-2 col-md-8">
        <div class="page-header text-center">
          <div class="icon-circle"> 
              <i class="fa icon1 fa-envelope-o"></i>
          </div>
          <h1>Invites</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/wedding-hub-invites1.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
             <h2><a href="{{url('details')}}"><font color="white">Valavi Cards</font></a></h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/wedding-hub-invites2.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Royal Cards</h2>
              <p> Royal Cards,Nagaroor Attingal, Trivandrum.</p>
              <p class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </p>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/wedding-hub-invites3.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Modern Cards</h2>
