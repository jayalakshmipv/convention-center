  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/entertainment-1.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
             <h2><a href="{{url('details')}}"><font color="white">Jacobs Entertainments</font></a></h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/entertainment-2.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2> Aswins DJ House</h2>
      ...
      <div class="col-md-4 vendor-box">
        <div class="grid">
          <figure class="effect-bubba"> <img src="images/entertainment-3.jpg" alt="wedding venue" class="img-responsive">
            <figcaption>
              <h2>Diana Entertainments</h2>
