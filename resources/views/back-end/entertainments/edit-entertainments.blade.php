...
@section('title', 'Update Entertainment')
...
@include('flash')
 ...
 <div class="box box-primary">
    <div class="box-body"> 
    {!! Form::model($entertainments,['method' => 'PATCH','route'=>['entertainments.update',$entertainments->id]]) !!}
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            {!! Form::label('type', 'Entertainment Type') !!}
