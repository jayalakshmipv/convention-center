    ...
    <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            {!! Form::date('event_date_from', null, ['class' => 'form-control', 'placeholder'=>'Enter Event Date From']) !!}

        </div>
        <div class="form-group">
            {!! Form::label('event_date_to', 'Event Date To') !!}
            {!! Form::date('event_date_to', null, ['class' => 'form-control', 'placeholder'=>'Enter Event Date To']) !!}
